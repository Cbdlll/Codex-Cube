...
impl Database {
    ...
    pub(crate) fn create_tables_on_conn(conn: &Connection) -> Result<(), AppError> {
        ...
        conn.execute("CREATE TABLE IF NOT EXISTS proxy_config (
            ...
            listen_port INTEGER NOT NULL DEFAULT 15921, enable_logging INTEGER NOT NULL DEFAULT 1,
        ...
        // - 旧表会在 apply_schema_migrations() 中迁移为多行结构后再插入。
        ...
        let _ = conn.execute(
            "ALTER TABLE proxy_config ADD COLUMN listen_port INTEGER NOT NULL DEFAULT 15921",
            [],
        );
        let _ = conn.execute(
    ...
    fn migrate_v1_to_v2(conn: &Connection) -> Result<(), AppError> {
        ...
        if Self::table_exists(conn, "proxy_config")? {
            ...
            Self::add_column_if_missing(
                ...
                "proxy_config",
                "listen_port",
                "INTEGER NOT NULL DEFAULT 15921",
            )?;
            Self::add_column_if_missing(
                conn,
                "proxy_config",
    ...
    fn migrate_v2_to_v3(conn: &Connection) -> Result<(), AppError> {
        ...
        // 说明：v3 结构将 Skills 的 SSOT 迁移到 ~/.codex-cube/skills/，
    ...
    fn migrate_v13_to_v14(conn: &Connection) -> Result<(), AppError> {
        ...
        conn.execute(
            "CREATE TABLE proxy_config_v14 (
                ...
                listen_port INTEGER NOT NULL DEFAULT 15921,
