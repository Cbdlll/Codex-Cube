...
pub async fn install_skill(
    ...
    install_skill_for_app("codex".to_string(), directory, service, app_state).await
}
...
pub fn uninstall_skill(
    ...
    uninstall_skill_for_app("codex".to_string(), directory, app_state)
}
