...
- 📦 **60+ provider presets** - Official, aggregator, third-party, and Chinese providers, addable manually in one click
...
- ✏️ **No more manual editing** - Import your existing config, use 60+ built-in provider presets, or create custom providers
...
2. **Add providers from presets** - Pick from 60+ built-in presets or add a custom provider manually, or build your own aggregate provider from multiple suppliers.
