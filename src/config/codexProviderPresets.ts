...
requires_openai_auth = true`,
  ...
  },
  {
    ...
    apiFormat: "openai_chat",
    modelCatalog: modelCatalog([
      { model: "glm-5.3", displayName: "GLM-5.3", contextWindow: 1048576 },
  ...
  },
  {
    ...
    modelCatalog: modelCatalog([
      ...
      { model: "glm-5", displayName: "GLM 5", contextWindow: 204800 },
      {
        model: "deepseek-v4-pro",
        displayName: "DeepSeek V4 Pro",
        contextWindow: 1048576,
      ...
      { model: "hy3", displayName: "Hunyuan 3", contextWindow: 256000 },
      {
        model: "hy3-preview",
        displayName: "Hunyuan 3 Preview",
        contextWindow: 256000,
      },
      {
        model: "gpt-5.6-luna",
