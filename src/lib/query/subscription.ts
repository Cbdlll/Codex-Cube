 ...
 *
 * 直接以 Codex Cube 自管的 ChatGPT 账号 ID 查询额度，供认证中心里逐个账号
 ...
 *
 * 与 `useSubscriptionQuota` 平行：数据走 Codex Cube 自管的 OAuth token，
 ...
 *
 * 与 `useCodexOauthQuota` 平行：数据走 Codex Cube 自管的 xAI OAuth token，
