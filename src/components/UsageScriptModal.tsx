...
function isOfficialSubscriptionProvider(provider: Provider) {
...
const UsageScriptModal: React.FC<UsageScriptModalProps> = ({
  ...
  const isOfficialSubscription = isOfficialSubscriptionProvider(provider);
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1.5">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1 text-primary hover:text-primary/80 transition-colors break-all align-baseline underline-offset-2 hover:underline"
                      >
