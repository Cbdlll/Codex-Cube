      ...
      <div className="space-y-4 rounded-lg border border-border bg-muted/40 p-6">
        ...
        <div className="grid grid-cols-2 gap-4 items-stretch">
          ...
          <div className="relative">
            <Button
              type="button"
              className={`w-full h-auto py-3 px-4 bg-primary text-primary-foreground hover:bg-primary/90 ${selectedFile && !isImporting ? "flex-col items-start" : "items-center"}`}
          ...
          <div>
            <Button
              type="button"
              className="w-full h-full py-3 px-4 bg-primary text-primary-foreground hover:bg-primary/90 items-center"
              onClick={onExport}
            >
